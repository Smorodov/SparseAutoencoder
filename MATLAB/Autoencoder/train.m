...
%hiddenSize = 196;       % количество скрытых узлов 
%sparsityParam = 0.1;  % желаемый средний уровень активации нейронов скрытого слоя.
                     % (этот параметр обозначен в лекции греческой буквой ро). 
%lambda =3e-3;     % коэффициент ослабления весов связей       
...
visibleSize = patchSize*patchSize;   % Количество входных узлов 
hiddenSize = 25;       % количество скрытых узлов 
sparsityParam = 0.01;  % желаемый средний уровень активации нейронов скрытого слоя.
lambda =1e-4;     % коэффициент ослабления весов связей     
beta = 3; 
